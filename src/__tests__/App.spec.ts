...
describe('App', () => {
  ...
  it('should not be able to create a customer with one e-mail that already registered', async () => {
  ...
  it('should not be able to create a product with a name that already registered', async () => {
